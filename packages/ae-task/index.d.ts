...
declare const Task: {
    ...
    Resolved<T = any>(data: T): AlgebraicTask<any, T>;
    Rejected<E_1 = any>(err: E_1): AlgebraicTask<E_1, any>;
    of: <T = any>(data: T) => AlgebraicTask<any, T>;
    fromPromise<E_2, T_1, Args extends any[] = any[]>(factory: (...a: Args) => Promise<T_1>, ...args: Args): AlgebraicTask<E_2, T_1>;
};
export default Task;
