...
export declare const call: import("./types").Operation<[any], any>;
export declare const callMulti: import("./types").Operation<[any], any>;
export declare const race: import("./types").Operation<any[], any>;
export declare const parallel: import("./types").Operation<any[], any[]>;
export declare const background: import("./types").Operation<any[], any[]>;
