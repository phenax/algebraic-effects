...
export declare const createEffect: <OpMap = Record<string, import("./types").OperationSignature>>(name: string, operations: Record<keyof OpMap, import("./types").OperationSignature>) => Effect<OpMap> & Record<keyof OpMap, (...a: any[]) => any>;
